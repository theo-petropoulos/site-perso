<section id="user" class="invisible">
    ...
    <div class="distorted" lang="fr">Statut : <h2 style="display:inline" class="str user2 invisible" lang="fr">Développeur web / sec</h2></div>
    <div class="distorted" lang="en">Status : <h2 style="display:inline" class="str user2 invisible" lang="en">Web / Sec developer</h2></div>
    <p class="distorted">Github : <a href="https://github.com/theo-petropoulos" class="str user3 invisible" target="_blank" rel="noopener noreferrer">Cliquez ici</a></p>
    <details>
