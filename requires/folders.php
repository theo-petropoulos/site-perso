<section id="folder_section" class="invisible">
    <div class="folder drag rclick" id="folder_images" style="top:calc(3% + 100px); left:calc(3% + 100px)">
    ...
    <div class="folder drag rclick" id="folder_projects" style="left:calc(3% + 100px)">
        <img src="<?=$addr;?>assets/images/icons/folder_green.png" alt="folder_image" title="folder_min">
    ...
    <div class="folder drag rclick" id="folder_infos" style="left:0px;top:calc(3% + 200px)">
    ...
    <div class="folder drag rclick" id="folder_credits" style="left:0px;top:calc(3% + 100px)">
